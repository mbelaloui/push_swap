...
#    Updated: 2019/03/02 14:50:04 by mbelalou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_CHECKER			= ft_get_id_action.c ft_get_index_action.c\
					  ft_init_action_name.c ft_run_ckecker.c main_checker.c
...
fclean			:
			...
			@#say "the $(NAME_P) and $(NAME_C) directory are totaly cleaned !"
